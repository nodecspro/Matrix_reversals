"""
    Программа Matrix_reversals
    Курсовой проект по предмету МДК.01.01 Разработка программных модулей по теме "Разработка программы обращения квадратной матрицы с помощью схемы гаусса"
    Язык: Python
    Разработал: Новиков А. С.
    Задание:
    Разработка программы для обращения квадратной матрицы методом Гаусса.
    
    Основные переменные, используемые в программе:
    matrix - исходная матрица
    augmented_matrix - расширенная матрица
    inverse_matrix - обратная матрица
    pivot_row - номер строки с максимальным элементом
    factor - коэффициент для преобразования матрицы
    row_entries - список элементов строки
    entry - элемент строки
    entry_value - значение элемента строки
    vcmd - команда для проверки вводимых данных
    ...
    gauss_elimination - вычисление обратной матрицы методом Гаусса
    is_valid_number - проверка, является ли строка действительным числом
    create_matrix_window - создание окна Toplevel для ввода матрицы
    hide_matrix_window - скрытие окна ввода матрицы
    calculate_inverse - вычисление обратной матрицы
"""
